...
import { type DbKegiatanMahasiswa } from '../../lib/mockData';

interface KegiatanMahasiswaTabProps {
  kegiatanList: DbKegiatanMahasiswa[];
  searchQuery: string;
  setSearchQuery: (q: string) => void;
  isLoadingData: boolean;
  openCreateModal: () => void;
  openEditModal: (item: DbKegiatanMahasiswa) => void;
  openDeleteModal: (id: string) => void;
}

export default function KegiatanMahasiswaTab({ kegiatanList, searchQuery, setSearchQuery, isLoadingData, openCreateModal, openEditModal, openDeleteModal }: KegiatanMahasiswaTabProps) {
