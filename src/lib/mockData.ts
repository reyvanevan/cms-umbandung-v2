...
export const initialSiteContent: DbSiteContent[] = [
  ...
  { key: 'capstone_heading', value: 'Capstone Design', value_en: 'Capstone Design', updated_at: new Date().toISOString() },
  { key: 'capstone_description', value: 'Studio integratif tempat mahasiswa menerjemahkan sains pangan, rekayasa proses, penjaminan mutu, dan kelayakan bisnis menjadi rancangan produk atau sistem yang teruji.', value_en: 'An integrative studio where students translate food science, process engineering, quality assurance, and business feasibility into a tested product or system design.', updated_at: new Date().toISOString() },
  { key: 'capstone_overview_title', value: 'Studio Perancangan Produk Terintegrasi', value_en: 'Integrated Product Design Studio', updated_at: new Date().toISOString() },
  { key: 'capstone_overview_desc', value: 'Capstone Design menghubungkan kebutuhan konsumen, uji formulasi, validasi proses, strategi kemasan, jaminan halal, dan perencanaan pasar dalam satu siklus proyek terbimbing.', value_en: 'Capstone Design connects consumer needs, formulation trials, process validation, packaging strategy, halal assurance, and go-to-market thinking in one guided project cycle.', updated_at: new Date().toISOString() },
  { key: 'capstone_outcomes', value: 'Prototipe atau rancangan proses tervalidasi beserta dokumentasi teknis.\nRencana mutu, keamanan pangan, dan jaminan halal untuk produk yang dirancang.\nAnalisis kelayakan bisnis, arahan kemasan, dan portofolio siap presentasi.', value_en: 'Validated prototype or process design with technical documentation.\nQuality, safety, and halal assurance plan for the proposed product.\nBusiness feasibility, packaging direction, and presentation-ready portfolio.', updated_at: new Date().toISOString() },
  { key: 'capstone_milestones', value: 'Perumusan Masalah | Menentukan kebutuhan pengguna, peluang produk, batasan, dan metrik keberhasilan.\nKonsep & Formulasi | Menyusun alternatif formula, rute proses, dan rencana pengujian.\nValidasi & Iterasi | Melakukan uji lab, sensoris, analisis mutu, dan penyempurnaan biaya.\nShowcase Akhir | Mempresentasikan dossier desain, prototipe, dan argumen kelayakan.', value_en: 'Problem Framing | Define user needs, product opportunity, constraints, and success metrics.\nConcept & Formulation | Develop formula alternatives, processing routes, and test plans.\nValidation & Iteration | Run lab trials, sensory checks, quality analysis, and cost refinement.\nFinal Showcase | Present the final design dossier, prototype, and feasibility argument.', updated_at: new Date().toISOString() },
  { key: 'capstone_deliverables', value: 'Dossier Desain | Rasional desain, catatan formula/proses, aspek keamanan, dan ringkasan validasi.\nPrototipe / Model | Prototipe produk, model proses, mockup kemasan, atau demonstrasi sistem.\nPitch Deck | Presentasi ringkas berisi masalah, solusi, bukti, kelayakan, dan dampak.', value_en: 'Design Dossier | Complete design rationale, formula/process record, safety notes, and validation summary.\nPrototype / Model | Physical product prototype, process model, packaging mockup, or system demonstration.\nPitch Deck | Concise presentation covering problem, solution, evidence, feasibility, and impact.', updated_at: new Date().toISOString() },
  { key: 'capstone_guide_url', value: '#', value_en: '#', updated_at: new Date().toISOString() },
  { key: 'capstone_cta_label', value: 'Buka Panduan Capstone', value_en: 'Open Capstone Guide', updated_at: new Date().toISOString() },
  { key: 'capstone_course_1_code', value: 'TP06135', value_en: 'TP06135', updated_at: new Date().toISOString() },
  { key: 'capstone_course_1_name', value: 'Teknologi Pengolahan dan Pengembangan Produk Pangan', value_en: 'Food Processing and Product Development Technology', updated_at: new Date().toISOString() },
  { key: 'capstone_course_1_desc', value: 'Mata kuliah ini berfungsi sebagai Fase Awal (Fase Produk) dari rangkaian Capstone Design di Program Studi Teknologi Pangan. Fokus utama mata kuliah ini adalah membekali mahasiswa dengan kemampuan komprehensif untuk merancang, memformulasi, dan mengevaluasi produk pangan baru yang aman, bermutu, dan inovatif.\n\nDalam konteks Capstone Design, mahasiswa dituntut berpikir kritis dalam memecahkan masalah nyata di industri pangan melalui pendekatan riset dan pengembangan (R&D). Proses perancangan produk dimulai dari tahapan:\n- Identifikasi ide produk dan analisis kebutuhan pasar (consumer insights).\n- Formulasi dan rekayasa proses pengolahan, termasuk eksplorasi kategori khusus seperti unique food, imitation food, maupun emerging food technology.\n- Evaluasi mutu menyeluruh (sensori, fisik, kimia) serta pemastian aspek keamanan pangan secara ketat.\n\nLuaran Akhir Capstone (Fase Produk): Mahasiswa menghasilkan sebuah prototipe produk pangan operasional (Minimum Viable Product / MVP) berskala laboratorium/pilot yang telah teruji karakteristik mutu dan keamanannya, serta siap untuk ditransisikan ke tahap hilirisasi bisnis.', value_en: 'This course serves as the Initial Phase (Product Phase) of the Capstone Design series in the Food Technology Study Program. The main focus is to equip students with comprehensive abilities to design, formulate, and evaluate new food products that are safe, high-quality, and innovative.\n\nIn the Capstone Design context, students are challenged to think critically to solve real problems in the food industry through research and development (R&D) approaches. The product design process begins with:\n- Identification of product ideas and market needs analysis (consumer insights).\n- Formulation and engineering of processing methods, including exploration of special categories such as unique food, imitation food, and emerging food technology.\n- Comprehensive quality evaluation (sensory, physical, chemical) and strict assurance of food safety aspects.\n\nCapstone Final Output (Product Phase): Students produce an operational food product prototype (Minimum Viable Product / MVP) at laboratory/pilot scale that has been tested for quality and safety characteristics, ready to be transitioned to the business downstreaming phase.', updated_at: new Date().toISOString() },
  { key: 'capstone_course_2_code', value: 'TP05130', value_en: 'TP05130', updated_at: new Date().toISOString() },
  { key: 'capstone_course_2_name', value: 'Wirausaha Teknologi Pangan (WTP)', value_en: 'Food Technology Entrepreneurship (WTP)', updated_at: new Date().toISOString() },
  { key: 'capstone_course_2_desc', value: 'Mata kuliah ini merupakan Fase Lanjutan (Fase Scale-Up & Komersialisasi) dari rangkaian Capstone Design, yang terintegrasi secara bertahap setelah mahasiswa berhasil menciptakan produk pada MK TP06135. Fokus utama mata kuliah ini adalah menstransformasi prototipe produk pangan tersebut ke dalam skala industri dan model bisnis yang layak.\n\nDengan mengadopsi pendekatan Islamic Technopreneurship, mahasiswa belajar memanfaatkan sumber daya lokal secara berkelanjutan. Integrasi Capstone Design pada mata kuliah ini ditekankan melalui: \n- Penerapan metodologi Design Thinking secara mendalam (mulai dari Empathize hingga Prototype final) untuk mematangkan konsep produk dari sudut pandang pengguna.\n- Analisis strategi scale-up produksi dan pemodelan bisnis yang komprehensif menggunakan Business Model Canvas (BMC).\n- Penyusunan strategi pemasaran digital, analisis kelayakan finansial yang terukur, serta penerapan prinsip keberlanjutan (sustainability).\n\nLuaran Akhir Capstone (Fase Scale-Up): Mahasiswa menghasilkan sebuah Business Plan komprehensif dan rencana scale-up produk (MVP bisnis) yang matang, legal, serta siap untuk dipresentasikan (pitching) secara profesional kepada calon investor atau pemangku kepentingan industri.', value_en: 'This course represents the Advanced Phase (Scale-Up & Commercialization Phase) of the Capstone Design series, integrated sequentially after students successfully develop a product in the TP06135 course. The primary focus is to transform the food product prototype into a viable industrial scale and business model.\n\nBy adopting the Islamic Technopreneurship approach, students learn to utilize local resources sustainably. The integration of Capstone Design in this course is emphasized through:\n- In-depth application of Design Thinking methodology (from Empathize to final Prototype) to mature product concepts from the user\'s perspective.\n- Analysis of production scale-up strategies and comprehensive business modeling using the Business Model Canvas (BMC).\n- Formulation of digital marketing strategies, measurable financial feasibility analysis, and application of sustainability principles.\n\nCapstone Final Output (Scale-Up Phase): Students generate a comprehensive Business Plan and scale-up plan (business MVP) that is mature, legal, and ready for professional pitching to potential investors or industry stakeholders.', updated_at: new Date().toISOString() },
  { key: 'spm_heading', value: 'Sistem Penjaminan Mutu', value_en: 'Quality Assurance System', updated_at: new Date().toISOString() },
  { key: 'spm_description', value: 'Kerangka penjaminan mutu terpadu yang menjaga pelaksanaan akademik, capaian pembelajaran, layanan, dan perbaikan berkelanjutan tetap selaras dengan standar universitas serta standar nasional pendidikan tinggi.', value_en: 'An integrated quality assurance framework that keeps academic delivery, learning outcomes, services, and continuous improvement aligned with university and national higher education standards.', updated_at: new Date().toISOString() },
  { key: 'spm_overview_title', value: 'Budaya Mutu Berkelanjutan', value_en: 'Continuous Quality Culture', updated_at: new Date().toISOString() },
  { key: 'spm_overview_desc', value: 'Teknologi Pangan menerapkan penjaminan mutu sebagai praktik akademik harian melalui penetapan, pelaksanaan, evaluasi, pengendalian, dan peningkatan pada kurikulum, pembelajaran, riset, pengabdian, serta layanan mahasiswa.', value_en: 'Food Technology applies quality assurance as a daily academic practice through planning, implementation, evaluation, control, and improvement across curriculum, learning, research, community service, and student services.', updated_at: new Date().toISOString() },
  { key: 'spm_policy_title', value: 'Arah Kebijakan Mutu', value_en: 'Quality Policy Direction', updated_at: new Date().toISOString() },
  { key: 'spm_policy_desc', value: 'Program studi menggunakan bukti evaluasi, umpan balik pemangku kepentingan, dan indikator kinerja akademik untuk memperkuat kompetensi lulusan serta akuntabilitas publik.', value_en: 'The study program uses evaluation evidence, stakeholder feedback, and academic performance indicators to strengthen graduate competence and public accountability.', updated_at: new Date().toISOString() },
  { key: 'spm_cycle_items', value: 'Penetapan Standar | Menerjemahkan standar mutu universitas menjadi target, prosedur, dan indikator terukur di tingkat program studi.\nPelaksanaan | Menjalankan pembelajaran, pembimbingan, penilaian, riset, dan layanan sesuai prosedur akademik yang berlaku.\nEvaluasi | Mengumpulkan bukti melalui survei, evaluasi pembelajaran, audit, dan rapat tinjauan kinerja.\nPeningkatan | Mengubah temuan menjadi tindakan korektif, rencana pengembangan, dan target mutu siklus berikutnya.', value_en: 'Set Standards | Translate university quality standards into study program targets, procedures, and measurable indicators.\nImplement | Run teaching, advising, assessment, research, and services according to approved academic procedures.\nEvaluate | Collect evidence through surveys, learning evaluations, audits, and performance review meetings.\nImprove | Convert findings into corrective actions, development plans, and the next cycle of quality targets.', updated_at: new Date().toISOString() },
  { key: 'spm_standards', value: 'Relevansi kurikulum, capaian pembelajaran, dan mutu penilaian.\nKinerja dosen, pembimbingan akademik, dan pengalaman belajar mahasiswa.\nRiset, pengabdian masyarakat, kemitraan, dan umpan balik pemangku kepentingan.\nRespons layanan akademik, dokumentasi, dan rekam jejak perbaikan yang tertelusur.', value_en: 'Curriculum relevance, learning outcomes, and assessment quality.\nLecturer performance, academic advising, and student learning experience.\nResearch, community service, partnership, and stakeholder feedback.\nAcademic service responsiveness, documentation, and traceable improvement records.', updated_at: new Date().toISOString() },
  { key: 'spm_roles', value: 'Pimpinan Program Studi | Mengkoordinasikan standar, rencana kerja, rapat evaluasi, dan keputusan tindak lanjut.\nUnit Penjaminan Mutu | Mendukung monitoring, dokumentasi, kesiapan audit, dan pelacakan peningkatan berkelanjutan.\nDosen & Tenaga Kependidikan | Menerapkan prosedur mutu pada pembelajaran, penilaian, pembimbingan, administrasi, dan layanan.', value_en: 'Study Program Leadership | Coordinates standards, work plans, evaluation meetings, and follow-up decisions.\nQuality Assurance Unit | Supports monitoring, documentation, audit readiness, and continuous improvement tracking.\nLecturers & Academic Staff | Implement quality procedures in learning, assessment, advising, administration, and services.', updated_at: new Date().toISOString() },
  { key: 'spm_document_url', value: '#', value_en: '#', updated_at: new Date().toISOString() },
  { key: 'spm_cta_label', value: 'Buka Dokumen Mutu', value_en: 'Open Quality Document', updated_at: new Date().toISOString() },
